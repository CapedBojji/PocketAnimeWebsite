...
function BackgroundVideo({src} : BackgroundVideoProps)
{
    ...
    return (<>
        <div className="w-full h-full absolute top-0 left-0">
            <div className="absolute bottom-[40px] left-[40px] w-10 h-10 p-2 rounded-full flex justify-center items-center z-10 text-white bg-[rgba(93,113,152,.4)] cursor-pointer hover:bg-[rgba(93,113,152,.6)]" onClick={setPlayingState}>
            ...
            <div className="absolute w-full h-full top-0">
                <VideoPlayer src={src} playing={playing} loop fullHeight/>
            </div>
        </div>    
